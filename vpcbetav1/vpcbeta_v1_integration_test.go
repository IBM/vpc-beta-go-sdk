...
func createVpcService(t *testing.T) *vpcbetav1.VpcbetaV1 {
...
func TestVPCResources(t *testing.T) {
	...
	t.Run("Create", func(t *testing.T) {
		...
		t.Run("Create Instance template", func(t *testing.T) {
			...
			template, _ := res.(*vpcbetav1.InstanceTemplate)
		...
		t.Run("Create Instance group manager autoscale", func(t *testing.T) {
			...
			manager, _ := res.(*vpcbetav1.InstanceGroupManager)
		...
		t.Run("Create Instance group manager action", func(t *testing.T) {
			...
			managerAction, _ := res.(*vpcbetav1.InstanceGroupManagerAction)
		...
		t.Run("Create Instance group manager policy", func(t *testing.T) {
			...
			managerPolicy, _ := res.(*vpcbetav1.InstanceGroupManagerPolicy)
...
func TestVPCAccessControlLists(t *testing.T) {
	...
	t.Run("ACL Resources", func(t *testing.T) {
		...
		t.Run("Create ACL Rule", func(t *testing.T) {
			...
			rule, _ := res.(*vpcbetav1.NetworkACLRuleNetworkACLRuleProtocolAll)
...
func TestVPCSecurityGroups(t *testing.T) {
	...
	t.Run("SG Resources", func(t *testing.T) {
		...
		t.Run("Create Security Group Target", func(t *testing.T) {
			...
			ValidateResponse(t, res, err, POST, detailed, increment)
			sgtarget, _ := res.(*vpcbetav1.SecurityGroupTargetReference)
		...
		t.Run("Create Security Group Rule", func(t *testing.T) {
			...
			sgRule, _ := res.(*vpcbetav1.SecurityGroupRuleSecurityGroupRuleProtocolAll)
...
func TestVPCVPN(t *testing.T) {
	...
	t.Run("VPC Resources", func(t *testing.T) {
		...
		t.Run("Create VPN Gateway", func(t *testing.T) {
			...
			vpn, _ := res.(*vpcbetav1.VPNGateway)
		...
		t.Run("Create Vpn Gateway Connections", func(t *testing.T) {
			...
			if statusChanged {
				...
				vpnGatewayConnection, _ := res.(*vpcbetav1.VPNGatewayConnection)
...
func TestFileShares(t *testing.T) {
	...
	t.Run("File shares", func(t *testing.T) {

		t.Run("List share profiles", func(t *testing.T) {
			res, _, err := ListShareProfiles(vpcService)
			ValidateListResponse(t, res, err, GET, detailed, increment)
			shareProfileName = res.Profiles[0].Name
		})

		t.Run("Get share profile", func(t *testing.T) {
			res, _, err := GetShareProfile(vpcService, *shareProfileName)
			ValidateResponse(t, res, err, GET, detailed, increment)
		})

		t.Run("List shares", func(t *testing.T) {
			res, _, err := ListShares(vpcService)
			ValidateListResponse(t, res, err, GET, detailed, increment)
		})

		t.Run("Create file share", func(t *testing.T) {
			name1 := "gsdk-share1-" + timestamp
			name2 := "gsdk-share2-" + timestamp

			res, _, err := CreateShare(vpcService, createdVpcID, &name1)

			ValidateResponse(t, res, err, POST, detailed, increment)
			createdShareID = res.ID
			createdReplicaShareID = res.ReplicaShare.ID
			res, _, err = CreateShare(vpcService, createdVpcID, &name2)
			createdShare1ID = res.ID
			createdReplicaShare1ID = res.ReplicaShare.ID
		})

		t.Run("Get share", func(t *testing.T) {
			res, detailedResponse, err := GetShare(vpcService, createdShareID)
			createdShareETag = detailedResponse.GetHeaders()["Etag"][0]
			ValidateResponse(t, res, err, GET, detailed, increment)
		})

		t.Run("Update file share", func(t *testing.T) {
			name := "gsdk-share-updated" + timestamp
			res, _, err := UpdateShare(vpcService, createdShareID, &createdShareETag, &name)
			ValidateResponse(t, res, err, PATCH, detailed, increment)
		})

		t.Run("Get Share Source", func(t *testing.T) {
			t.Skip("Mock does not support")
			res, _, err := GetShareSource(vpcService, createdReplicaShareID)
			ValidateResponse(t, res, err, GET, detailed, increment)
		})

		t.Run("Fail over share", func(t *testing.T) {
			res, err := FailoverShare(vpcService, createdShareID)
			ValidateResponse(t, res, err, POST, detailed, increment)
		})

		t.Run("List share targets", func(t *testing.T) {
			res, _, err := ListShareTargets(vpcService, createdShareID)
			ValidateListResponse(t, res, err, GET, detailed, increment)
		})

		t.Run("Create share target", func(t *testing.T) {
			name := "gsdk-share-target" + timestamp
			res, _, err := CreateShareTarget(vpcService, createdVpcID, createdShareID, &name)
			ValidateResponse(t, res, err, POST, detailed, increment)
			createdShareTargetID = res.ID
		})

		t.Run("Get Share target", func(t *testing.T) {
			res, _, err := GetShareTarget(vpcService, createdShareID, createdShareTargetID)
			ValidateResponse(t, res, err, GET, detailed, increment)
		})

		t.Run("Update file share target", func(t *testing.T) {
			name := "gsdk-share-target-updated" + timestamp
			res, _, err := UpdateShareTarget(vpcService, createdShareID, createdShareTargetID, &name)
			ValidateResponse(t, res, err, PATCH, detailed, increment)
		})

		t.Run("Delete Share target", func(t *testing.T) {
			res, detailedResponse, err := DeleteShareTarget(vpcService, createdShareID, createdShareTargetID)
			ValidateDeleteResponse(t, res, err, DELETE, detailedResponse.StatusCode, detailed, increment)
		})

		t.Run("Delete Share source", func(t *testing.T) {
			res, err := DeleteShareSource(vpcService, createdShare1ID)
			ValidateDeleteResponse(t, res, err, DELETE, res.StatusCode, detailed, increment)
		})

		t.Run("Delete Share", func(t *testing.T) {
			res, detailedResponse, err := DeleteShare(vpcService, createdShareID, &createdShareETag)
			ValidateDeleteResponse(t, res, err, DELETE, detailedResponse.StatusCode, detailed, increment)
		})
	})
	printTestSummary()
